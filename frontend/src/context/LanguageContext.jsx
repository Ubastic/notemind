...
const RESOURCES = {
  en: {
    ...
    strings: {
      ...
      ai: {
        organizeTitle: "AI Knowledge Organization",
        organizeIntro: "AI will analyze all your notes and propose a new directory structure based on semantic similarity. This is a heavy operation.",
        startOrganize: "Start Organization",
        processing: "AI is analyzing your notes... This may take a minute.",
        proposedStructure: "Proposed Structure",
        previewHint: "Click names to rename. Use the arrow to move folders.",
        uncategorizedCount: "{count} notes could not be categorized automatically.",
        applying: "Applying changes...",
        success: "Organization applied successfully!",
        organizeButton: "Organize with AI",
      },
      share: {
  ...
  zh: {
    ...
    strings: {
      ...
      ai: {
        organizeTitle: "AI 知识整理",
        organizeIntro: "AI 将分析您的所有笔记，并基于语义相似度建议新的目录结构。这是一个繁重的操作。",
        startOrganize: "开始整理",
        processing: "AI 正在分析您的笔记... 这可能需要一分钟。",
        proposedStructure: "建议结构",
        previewHint: "点击名称可重命名。使用箭头移动文件夹。",
        uncategorizedCount: "{count} 条笔记无法自动归类。",
        applying: "应用更改中...",
        success: "整理已应用！",
        organizeButton: "AI 一键整理",
      },
      share: {
        readOnly: "只读视图。",
        sharedNote: "共享笔记",
